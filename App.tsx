      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex-shrink-0 cursor-pointer" onClick={resetHome}>
            <span className="font-serif text-2xl tracking-widest text-gray-900">XAVI.PH</span>
          </div>
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <button 
                ...
                className="px-6 py-2 bg-gray-900 text-white text-xs uppercase tracking-widest hover:bg-gray-700 transition-colors"
            >
                Portal
            </button>
          </div>
    ...
    <footer className="bg-white border-t border-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 flex-wrap justify-center">
                <a href="https://www.instagram.com/xavi.ph/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 text-sm transition-colors">Instagram</a>
                <a href="https://www.facebook.com/p/Xaviph-61565396845921/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 text-sm transition-colors">Facebook</a>
                <a href="https://www.tiktok.com/@xavi.phvp" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 text-sm transition-colors">TikTok</a>
                <a href="https://api.whatsapp.com/send?phone=5215615567863" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 text-sm transition-colors">WhatsApp</a>
            </div>
        </div>
    </footer>
  );
    ...
    switch (currentView) {
          ...
          <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
            <div className="max-w-md w-full bg-white p-8 rounded shadow-sm border border-gray-100">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-serif">Acceso Administrativo</h2>
                ...
                <form onSubmit={handleAdminLogin} className="space-y-6">
                    ...
                    <button type="submit" className="w-full bg-black text-white py-3 rounded hover:bg-gray-800 transition-colors">
                        Entrar al Portal
                    </button>
                </form>
                <button onClick={() => setCurrentView('home')} className="mt-6 text-sm text-gray-400 w-full text-center hover:underline">
                    Regresar al Inicio
                </button>
            </div>
          </div>
      ...
      case 'client-login':
        return (
            ...
            <div className="max-w-md w-full bg-white p-8 rounded shadow-sm border border-gray-100">
                <div className="text-center mb-8">
                    <Camera className="w-10 h-10 mx-auto text-gray-300 mb-4" />
                    <h2 className="text-2xl font-serif">Área de Clientes</h2>
                    <p className="text-gray-500 text-sm mt-2">Accede a tu galería privada para seleccionar fotos.</p>
                </div>
